...
#define CAP_LUA_OUTPUT_SIZE             CONFIG_CAP_LUA_OUTPUT_SIZE
#define CAP_LUA_SYNC_DEFAULT_TIMEOUT_MS 60000
#define CAP_LUA_ASYNC_DEFAULT_TIMEOUT_MS 0
#define CAP_LUA_ASYNC_LOG_DEFAULT_BYTES CONFIG_CAP_LUA_ASYNC_LOG_DEFAULT_BYTES
...
#define CAP_LUA_ASYNC_MAX_JOBS          CONFIG_CAP_LUA_MAX_JOBS
#define CAP_LUA_ASYNC_MAX_CONCURRENT    CONFIG_CAP_LUA_MAX_CONCURRENT
