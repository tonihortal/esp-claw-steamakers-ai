> [!IMPORTANT]
> **ESP-Claw per a ESP32 STEAMakers AI.** Aquest fork afegeix una definició de
> placa i un firmware validat per a la STEAMakers AI / Keyestudio KS5034 amb
> ESP32-S3-WROOM-1-N16R8, pantalla ST7789, micròfon INMP441, amplificador
> MAX98357A, Telegram i control protegit de GPIO.
>
...
> **PROG/CH340**, no pel port USB OTG. El pin `V` dels connectors proporciona
> 5 V, però el senyal `S` continua sent lògica de 3,3 V.
